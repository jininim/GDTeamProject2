...
public class AddMaps extends AppCompatActivity implements OnMapReadyCallback {
    DBHelper dbHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_maps);
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        editMap = findViewById(R.id.edit_map1);
        btnMap = findViewById(R.id.btn_map1);
        ...
        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener(){
            ...
            public void onInfoWindowClick(Marker marker) {
                Intent it = new Intent(getBaseContext(), AddStore.class);
